...
def main():
  ...
  if p is not False:
    ...
    try:
      ...
      create.create_datasets(resource_dict=resource_dict, hdx_site=p['hdx_site'], apikey=os.getenv('HDX_KEY'), verbose=p['verbose'], update_all_datasets=p['update_all_datasets'])
