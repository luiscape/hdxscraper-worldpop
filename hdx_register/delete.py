...
Script that manages the record delete functions.
It is called in the case the repository needs to
be "cleaned" before a new registration function is
executed.
...
def delete_resources(dataset_dict, hdx_site, apikey, verbose=True):
