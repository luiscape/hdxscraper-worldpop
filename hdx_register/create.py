...
Scripts that creates all main elements in HDX:
datasets, resources, and gallery items. This script
automatically checks if those items exist before
creating them, and and handles an array of
possible errors.
...
def create_resources(resource_dict, hdx_site, apikey, verbose=True, update_all_datasets=False):
  '''Create datasets based on dictionaries.'''
...
def create_gallery_items(gallery_dict, hdx_site, apikey, verbose=True, update_all_datasets=False):
  '''Create datasets based on dictionaries.'''
